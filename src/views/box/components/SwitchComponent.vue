...
<style lang="scss">
    ...
    outline: 0;	    border-radius: 16px;
    box-sizing: border-box;
    background-color: #DFDFDF;	    transition: background-color 0.1s, border 0.1s;
    cursor: pointer;	  }
   .weui-switch:before {
    content: "";
    position: absolute;
    ...
    height: 22px;
    border-radius: 15px;
    background-color: #FDFDFD;	    transition: transform 0.35s cubic-bezier(0.45, 1, 0.4, 1);
  }
.weui-switch:after {
    text-align: center;
content: "";
